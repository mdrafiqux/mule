...
import ACCESSMANAGEMENTDATA from "../accessmanagement.json";
  ...
  return (
    <>
      <div className="container">
        <div className="app">
         ...
         <div className="fixed-container">
          ...
          {ACCESSMANAGEMENTDATA.filter((val) => {
            if (searchTerm === "") {
              // return val;
      ...
      <div className="container pad-lr-20 m-top-135">
        ...
        {
         ACCESSMANAGEMENTDATA.map( (questions,key) => {
            return(
              <>
        ...
        {
         ACCESSMANAGEMENTDATA.map( (questionblocks, key) => {
            return(
              <>
